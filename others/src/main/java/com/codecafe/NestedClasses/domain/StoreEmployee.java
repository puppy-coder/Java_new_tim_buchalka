...
public class StoreEmployee extends Employee{
    ...
    } // No-args constructor to access this comparator from the calling code.
    ...
    public class StoreComparator<T extends StoreEmployee> implements Comparator<StoreEmployee>{
        ...
        public int compare(StoreEmployee o1, StoreEmployee o2) {
            ...
            return result; // if the result is 0, the employees works at same store
        }
    }
}